...
do_install() {
	...
	install -m 0755 ${WORKDIR}/gps0 ${D}${sysconfdir}/init.d/

        ln -sf ../init.d/gps0 ${D}${sysconfdir}/rc0.d/K20gps0
        ln -sf ../init.d/gps0 ${D}${sysconfdir}/rc1.d/K20gps0
        ln -sf ../init.d/gps0 ${D}${sysconfdir}/rc2.d/K20gps0
        ln -sf ../init.d/gps0 ${D}${sysconfdir}/rc3.d/K20gps0
        ln -sf ../init.d/gps0 ${D}${sysconfdir}/rc4.d/S20gps0
        ln -sf ../init.d/gps0 ${D}${sysconfdir}/rc5.d/S20gps0
        ln -sf ../init.d/gps0 ${D}${sysconfdir}/rc6.d/K20gps0
}
